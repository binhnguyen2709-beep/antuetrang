...
// products.json là dữ liệu sống (admin panel ghi đè khi chạy) nên không nằm
// trong git — chỉ products.seed.json (danh mục mẫu ban đầu) được theo dõi.
// Lần chạy đầu tiên trên một server/máy mới, tự tạo products.json từ seed.
function ensureFile() {
